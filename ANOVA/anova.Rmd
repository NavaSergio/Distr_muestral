...
renderPlot({
  ...
  if (input$Intervalo) 
    g1 <- base2 + geom_errorbar(data=resumen,aes(ymin=y-ci, ymax=y+ci), width=.1, color ="blue")
  else
    g1 <- base2 + geom_dotplot(binaxis='y', stackdir='center', dotsize=.3, colour = tratamiento, fill =tratamiento)
