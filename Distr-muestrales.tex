...
Ver el archivo \textbf{distr\_muestral\_pequena2.R} en
\url{https://rstudio.cloud/content/4731243}

Simule la distribución muestral de la suma, mínimo y varianza para una
población dada. La extracción será con reemplazo y con tamaño de muestra
\(n\) fijo. Grafique la distribución muestral.
\end{block}
\end{frame}
