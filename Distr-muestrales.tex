...
\toprule()
\endhead
\includegraphics[width=0.4\textwidth,height=\textheight]{figuras/Papel1.png}
&
\includegraphics[width=0.4\textwidth,height=\textheight]{figuras/Papel2.png} \\
\includegraphics[width=0.4\textwidth,height=\textheight]{figuras/Papel3.png}
&
\includegraphics[width=0.4\textwidth,height=\textheight]{figuras/Papel4.png} \\
\bottomrule()
\end{longtable}
\end{frame}
